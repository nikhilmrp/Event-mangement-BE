...
router.get(
  "/get-vendor-catogories-by-vendor-type-id/:vendor_type_id",
  authenticate,
  vendorCategoryController.getVendorCategoriesByVendorTypeId,
);

router.get(
  "/get-all-vendor-categories",
  authenticate,
  vendorCategoryController.getAllVendorCategories,
);
