...
interface VendorProfileCreationAttributes
    extends Optional<VendorProfileAttributes, "id" | "profile_completed" | "profile_step" | "user_id" | "vendor_type_id"> {}
