...
interface VendorProfileCategoryCreationAttributes extends Optional<
  VendorProfileCategoryAttributes,
  "id" | "created_at" | "updated_at"
> {}

class VendorProfileCategory
  extends Model<VendorProfileCategoryAttributes, VendorProfileCategoryCreationAttributes>
  implements VendorProfileCategoryAttributes
{
  public id!: number;
